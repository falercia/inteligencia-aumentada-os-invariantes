...
A obsessão é com benchmarks, rankings, versões, lançamentos. Empresas trocam fornecedor a cada ciclo de lançamento, equipes refazem prompts a cada versão nova, dirigentes pedem estratégia de IA em reunião sem saber o que pediram. É um erro de categoria.
...
Recusei essa opção desde o primeiro rascunho — não porque o mercado não precise de execução, mas porque o mercado já tem execução em abundância. O que falta é critério. Os livros que sobrevivem na minha estante são os que ensinam a pensar, não os que ensinam a operar. O princípio dobra a década. A versão dura um trimestre.
...
Os profissionais e empresas que entenderam a internet antes do ciclo de adoção em massa ganharam vantagem estrutural que durou uma década — não por ter acesso, mas por ter compreensão. A mesma lógica se repetiu com a nuvem. Em IA, o padrão deve se repetir, com velocidade maior. Quem souber ler a IA agora vai ganhar a próxima década. Não por ter acesso, porque acesso, hoje, é commodity. Vai ganhar por compreender, mais profundamente que os outros, o que essa onda específica está reorganizando no mundo.
