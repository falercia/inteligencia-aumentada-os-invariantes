...
<!-- NOTA INTERNA DE PRODUÇÃO: linha curta para canais digitais = "O livro que separa o padrão do botão." Não incluir em arquivo enviado ao designer ou distribuidor. -->
...
| Elemento | Definição |
|----------|-----------|
| **Categoria** | Livro técnico-executivo de inteligência artificial, referência conceitual |
...
> Texto editorial da quarta capa: ver `L1-12-quarta-capa.md` (versão canônica).
...
| Edição | 1ª |
| Ano | 2026 |
| ISBN | [PENDENTE — responsável: autor — prazo: antes do depósito legal] |
| Ficha CIP | [PENDENTE — responsável: bibliotecário CRB — prazo: antes da impressão] |
| Depósito legal | conforme legislação BR vigente |
