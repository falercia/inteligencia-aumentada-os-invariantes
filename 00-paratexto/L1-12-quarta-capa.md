# QUARTA CAPA — TEXTO EDITORIAL

---

> **A diferença entre quem dominará a Inteligência Artificial e quem será dominado por ela não é tecnológica. É de método.**
...
O livro tem repositório acompanhante público — sete pastas de artefatos executáveis, incluindo prompts em XML com golden sets, agentes educacionais em Python e caderno operacional de governança. O método mora no livro. A implementação mora no repositório.

**Para o profissional brasileiro que quer construir, não apenas opinar.**
**Para o executivo que quer decidir, não apenas reagir.**
**Para o operador que quer durar, não apenas surfar.**
