...
A boa notícia é que existem padrões reproduzíveis para construir prompts bons, e esses padrões podem ser aprendidos e aplicados sistematicamente. A má notícia é que a maioria das organizações ainda trata prompt engineering como se fosse improviso criativo, deixando engenheiros sêniors descobrirem por conta própria o que funciona, sem repositório compartilhado, sem versionamento, sem testes, sem governança. Esse capítulo é o ponto em que você sai desse improviso e começa a operar com método.

---

## 9.2 — ANALOGIA: A INSTRUÇÃO PARA O ESTAGIÁRIO BRILHANTE

Para tornar concreto o tipo de cuidado que prompt engineering exige, pense no seguinte arranjo profissional. Você precisa que um estagiário recém-contratado, brilhante mas sem contexto sobre sua empresa, faça uma análise importante até o fim do dia. Você tem duas formas de pedir.
...
O terceiro bloco são os **exemplos**, quando você quer calibrar o padrão de resposta com casos concretos. São os famosos few-shot, que veremos com cuidado em 9.3.2, e que costumam ser a alavanca de qualidade mais subutilizada em prompts corporativos.
...
>
> ![Anatomia de um Prompt](file:///sessions/festive-eloquent-fermat/mnt/Ebook IA/Livro-1-Os-Invariantes/02-capitulos/imagens/cap-09-img-01-anatomia-prompt.svg)
>
...
Uma das decisões mais importantes em prompt engineering é quantos exemplos incluir. Há três padrões clássicos com nomes específicos, e cada um tem seu lugar.
...
>
> ![Zero, One, Few-shot](file:///sessions/festive-eloquent-fermat/mnt/Ebook IA/Livro-1-Os-Invariantes/02-capitulos/imagens/cap-09-img-02-zero-one-few-shot.svg)
>
...
>
> ![XML, Markdown, JSON](file:///sessions/festive-eloquent-fermat/mnt/Ebook IA/Livro-1-Os-Invariantes/02-capitulos/imagens/cap-09-img-03-xml-vs-markdown.svg)
>
...
- 🔗 **Tokens, base de custo dos prompts** → [Capítulo 3](L1-C03-tokens.md)
- 🔗 **Janela de contexto e Lost in the Middle** → [Capítulo 4](L1-C04-janela-de-contexto.md)
- 🔗 **Chain of Thought, técnica de raciocínio** → [Capítulo 10](cap-10-chain-of-thought.md)
- 🔗 **Context Engineering, evolução do prompt engineering** → [Capítulo 11](cap-11-context-engineering.md)
- 🔗 **Claude Projects para prompts persistentes** → [Capítulo 20](../../Livro-2-Dominando-Claude/02-capitulos/L2-C20-projects.md)
- 🔗 **Claude Skills como encapsulamento de prompts** → [Capítulo 31](../../Livro-2-Dominando-Claude/02-capitulos/L2-C31-skills.md)
- 🔗 **Economia de tokens via caching** → [Capítulo 36](L1-C36-economia-tokens.md)
...
| 4 | **Conexão** — Articular como prompt engineering se conecta com tokens (Cap 3), janela (Cap 4), CoT (Cap 10), Context Engineering (Cap 11) | ☐ |
| 5 | **Curiosidade UAU** — Está com vontade de aprender como provocar raciocínio explícito em modelos para tarefas complexas | ☐ |

**5 de 5?** Avance. Você acabou de internalizar a base que vai te diferenciar da maioria dos profissionais que usa IA hoje no Brasil.
**3 ou 4?** Releia 9.5 (caso da e-commerce) e 9.3.1 (anatomia). É onde teoria vira ROI.
**Menos de 3?** O capítulo merece releitura, sobretudo se você usa IA em volume profissional.

---

🔗 **Próximo capítulo:** [Capítulo 10 — Chain of Thought e Raciocínio](cap-10-chain-of-thought.md)
...
> Chain of Thought reduz erro por restringir a sequência plausível com etapas intermediárias verificáveis. Ainda é raciocínio aparente, não real; calibração de confiança segue valendo.
> Invariante secundário: **Inv. 2 — Extremidades** (a instrução para "pensar passo a passo" precisa estar nas posições críticas do prompt).
...
>
> ![Chain of Thought vs Resposta Direta](file:///sessions/festive-eloquent-fermat/mnt/Ebook IA/Livro-1-Os-Invariantes/02-capitulos/imagens/cap-10-img-01-cot-vs-direto.svg)
>
...
>
> ![Tree of Thoughts](file:///sessions/festive-eloquent-fermat/mnt/Ebook IA/Livro-1-Os-Invariantes/02-capitulos/imagens/cap-10-img-02-tree-of-thoughts.svg)
>
...
- 🔗 **Como modelos geram texto token por token** → [Capítulo 2](L1-C02-como-modelos-funcionam.md)
- 🔗 **Engenharia de prompt como base** → [Capítulo 9](cap-09-engenharia-prompt.md)
- 🔗 **Context Engineering, evolução natural** → [Capítulo 11](cap-11-context-engineering.md)
- 🔗 **Agentes que usam CoT para planejar** → [Capítulo 12](L1-C12-agentes.md)
- 🔗 **Modelos com raciocínio nativo** → [Capítulo 15](L1-C15-comparacao-modelos.md)
- 🔗 **Claude com modo de raciocínio estendido** → [Capítulo 18](../../Livro-2-Dominando-Claude/02-capitulos/L2-C18-modelos-claude.md)
- 🔗 **Segurança e auditabilidade** → [Capítulo 37](L1-C37-seguranca.md)
...
| 4 | **Conexão** — Articular como CoT se conecta com prompt engineering (Cap 9), context engineering (Cap 11), agentes (Cap 12) | ☐ |
| 5 | **Curiosidade UAU** — Está com vontade de aprender as técnicas avançadas de orquestração de contexto para sistemas maduros | ☐ |

**5 de 5?** Avance. Você acabou de ganhar uma das técnicas com maior ROI em prompt engineering.
**3 ou 4?** Releia 10.4 (caso da telemedicina) e 10.3.3 (variantes avançadas). É onde a técnica vira prática profissional.
**Menos de 3?** O capítulo merece releitura, especialmente as seções 10.3.1 e 10.3.2.

---

🔗 **Próximo capítulo:** [Capítulo 11 — Context Engineering](cap-11-context-engineering.md)
...
> 🧭 **Invariante-mãe:** **Invariante 2 — Extremidades** — *"O meio do contexto é onde a informação vai morrer."*
> Context engineering é o nome maduro do trabalho que opera o Invariante 2 em escala: orquestrar hierarquia, recuperação, caching e medição de tudo que entra no contexto.
> Invariante secundário: **Inv. 3 — Camada Dupla** (system prompt = padrão; conteúdo da chamada = número).
> Framework derivado: **F4 — PROMPT-EXT**.
...
> 📊 **Diagrama 11.1 — De Prompt Engineering para Context Engineering**
>
> ![Evolução prompt → context](file:///sessions/festive-eloquent-fermat/mnt/Ebook IA/Livro-1-Os-Invariantes/02-capitulos/imagens/cap-11-img-01-evolucao-prompt-context.svg)
>
...
>
> ![Hierarquia do contexto](file:///sessions/festive-eloquent-fermat/mnt/Ebook IA/Livro-1-Os-Invariantes/02-capitulos/imagens/cap-11-img-02-hierarquia-contexto.svg)
>
...
>
> ![Prompt Caching](file:///sessions/festive-eloquent-fermat/mnt/Ebook IA/Livro-1-Os-Invariantes/02-capitulos/imagens/cap-11-img-03-prompt-caching.svg)
>
...
- 🔗 **Tokens, a unidade de custo do contexto** → [Capítulo 3](L1-C03-tokens.md)
- 🔗 **Janela de contexto e Lost in the Middle** → [Capítulo 4](L1-C04-janela-de-contexto.md)
- 🔗 **RAG como camada dinâmica de contexto** → [Capítulo 6](L1-C06-rag.md)
- 🔗 **Memória externa em arquitetura de agentes** → [Capítulo 7](L1-C07-memoria.md)
- 🔗 **Engenharia de prompt como base** → [Capítulo 9](cap-09-engenharia-prompt.md)
- 🔗 **Chain of Thought e custo em tokens** → [Capítulo 10](cap-10-chain-of-thought.md)
- 🔗 **Agentes que orquestram contexto dinamicamente** → [Capítulo 12](L1-C12-agentes.md)
...
| # | Critério | Você consegue? |
|---|----------|----------------|
| 1 | **Clareza** — Explicar a diferença entre prompt engineering e context engineering em 90 segundos | ☐ |
...
| 5 | **Curiosidade UAU** — Está com vontade de avançar para a Parte 3 e entender como agentes orquestram contexto dinamicamente em ciclos de execução | ☐ |

**5 de 5?** Avance. Você acabou de fechar a Parte 2 do livro, e está pronto para entrar no território onde a IA moderna realmente acontece, que é o dos agentes.
**3 ou 4?** Releia 11.4 (caso da fintech) e 11.3.1 (hierarquia). É onde a disciplina vira economia mensurável.
**Menos de 3?** O capítulo merece releitura completa, especialmente se você participa de decisões sobre arquitetura de aplicações de IA.

---

🔗 **Próximo capítulo:** [Capítulo 12 — Agentes de IA](L1-C12-agentes.md)
