...
![Três faixas de PME brasileira — banda do dono, orçamento, TCO e exposição regulatória](file:///sessions/relaxed-cool-bell/mnt/Ebook IA/Livro-1-Os-Invariantes/02-capitulos/imagens/L1-C45-img-01-faixas-pme.svg)
...
![Cinco níveis da interpretabilidade — do comportamento observável à intervenção causal sobre circuits](file:///sessions/relaxed-cool-bell/mnt/Ebook IA/Livro-1-Os-Invariantes/02-capitulos/imagens/L1-C46-img-01-stack-interpretabilidade.svg)
...
O caso Golden Gate Claude, citado em 28.3.2, opera como demonstração pública do que a interpretabilidade permite em 2026, e a sua leitura por executivo brasileiro merece três atenções. Primeira atenção, a demonstração é didática, não operacional, com o objetivo sendo mostrar que features são identificáveis e manipuláveis, não que manipulação de feature é caminho de produto. Segunda atenção, o comportamento bizarro do modelo após manipulação (obsessão patológica pela ponte) mostra que intervenção em feature isolada produz efeito que não é simplesmente "modelo mais focado em conceito", o que é em si lição sobre a complexidade dos circuits e sobre o cuidado necessário em intervenção. Terceira atenção, a publicação aberta da técnica e da demonstração pela Anthropic é parte de cultura de transparência no campo, e a leitura do material original (disponível em transformer-circuits.pub) é leitura útil para o CTO que quer formar visão própria.
...
| Nível de autonomia | Assistente · Co-piloto · Agente supervisionado · Agente autônomo regulado (define-se via Escala de Propriedade do Agente) |
| Plano de eval | Golden set inicial, métrica primária, gate de bloqueio (via Pirâmide da Avaliação) |
...
| **Código** | Edição de código real, com testes, contexto longo, refatoração | Tier premium com força específica em SWE-bench Verified, HumanEval e LiveCodeBench — varia por release |
...
| **Custo crítico** | Volume altíssimo, margem apertada, classificação simples em produção | Variante econômica do tier (Haiku, Mini, Flash) ou modelo open weights self-hosted (Llama, Mistral, DeepSeek, Qwen, Phi) |
...
## 8. EXEMPLO MEMORÁVEL — A TELECOM QUE USOU CINCO MECANISMOS DE CADA VEZ
...
## 10. APLICAÇÃO PRÁTICA EM 30 MINUTOS
