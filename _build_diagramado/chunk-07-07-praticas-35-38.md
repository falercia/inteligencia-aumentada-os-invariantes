...
<p class="dropcap">Existe uma narrativa pública sobre open source em IA que precisa ser atualizada com honestidade, e a forma de atualizar é distinguir o discurso de três janelas temporais sucessivas. Na janela de 2020 a 2022, open source em modelos de linguagem era alternativa de qualidade marcadamente inferior, com gap visível em qualquer benchmark sério, com o uso justificando-se apenas em pesquisa acadêmica, em prototipação leve, em casos em que o requisito de soberania era tão crítico que o gap de qualidade entrava como custo aceito. Na janela de 2023, o Llama 2 e o Mistral abriram o caminho para que open source virasse alternativa viável em casos específicos, com qualidade próxima da fronteira proprietária em tarefas particulares, ainda com gap em capacidades complexas. Na janela de 2024 a 2026, três eventos compostos reescreveram a relação. Primeiro, o DeepSeek V3 chegou em dezembro de 2024 com arquitetura Mixture of Experts (671 bilhões de parâmetros totais, 37 bilhões ativos por token), com qualidade próxima do GPT-4o em benchmarks centrais, com custo de treino que a comunidade técnica considerou ordem de grandeza menor do que o esperado, com pesos liberados em licença MIT que permite uso comercial irrestrito. Segundo, o DeepSeek R1, em janeiro de 2025, demonstrou que raciocínio em janela longa, com chain-of-thought visível, podia ser entregue em modelo open weights com qualidade comparável à do o1 da OpenAI. Terceiro, a família Llama 3.3 da Meta, o Mistral Large 2, o Qwen 2.5 da Alibaba e a evolução da família Phi da Microsoft consolidaram o campo, com pelo menos quatro famílias open source em 2026 entregando qualidade aceitável para uso corporativo sério.</p>
...
A analogia com open source × API em IA é direta em quatro pontos. Primeiro, a virada tecnológica reorganizou a matriz, com open source em 2026 sendo competitivo em qualidade da forma como carro elétrico em 2026 é competitivo em desempenho, e a decisão precisa partir do mapa atual, não do mapa de 2022. Segundo, o ponto de virada econômico depende do volume saturado, com a fronteira sendo, em ordem de grandeza, "usuário com menos de cem requisições por dia" claramente em API e "usuário com mais de dez mil requisições por dia" justificando análise séria de self-hosting, e a zona intermediária exigindo arquitetura híbrida. Terceiro, o requisito regulatório, em 2026 com LGPD em maturação e com nota técnica da ANPD sobre IA generativa, desloca a fronteira em favor de open source self-hosted em território nacional para classes específicas de dado pessoal sensível. Quarto, a maturidade do time é variável estrutural, com a operação de self-hosting exigindo competência específica em inferência, em quantização, em observabilidade de GPU, em otimização de batching, e essa competência tem custo de aquisição que entra no TCO honesto.

A próxima seção desce ao detalhe técnico da matriz.

## 16.3 — Explicação técnica

### 16.3.1 — A família competitiva de modelos open source em 2026

![Ecossistema open source em 2026 — famílias de modelos, licenças e janelas competitivas](file:///sessions/relaxed-cool-bell/mnt/Ebook IA/Livro-1-Os-Invariantes/02-capitulos/imagens/cap-16-img-01-ecossistema-open-source.svg)

A lista de fornecedores de modelos open weights em 2026 é mais densa do que a maioria do mercado brasileiro percebe, e o operador profissional precisa conhecer pelo menos a constelação central, com critério explícito de comparação.

**DeepSeek (laboratório chinês).** Família com DeepSeek V3 (671B MoE, 37B ativos), DeepSeek R1 (raciocínio com chain-of-thought), DeepSeek V3.1 (atualização incremental em 2025), todos em licença MIT. Qualidade de fronteira em raciocínio, em código, em multilíngue. Comunidade técnica internacional ativa, com integração madura em vLLM, em SGLang, em Hugging Face. O ponto crítico para o operador brasileiro é a origem chinesa do laboratório, com a discussão de jurisdição de dado de treino e de viés institucional sendo legítima e separada da decisão de adoção em produção (modelo rodando em infraestrutura brasileira não envia dado de inferência para a China; a discussão é sobre confiança no modelo, não sobre canal de dado).

**Meta Llama 3.3 e 4.** Família com variantes de 8B, 70B, 405B e variantes especializadas. Licença Meta Llama Community License com restrição comercial específica (uso aceito até 700 milhões de usuários ativos mensais, com licença separada acima desse piso). A licença é open weights, não open source no sentido estrito da definição da OSI, com a distinção importando para organização que precisa de compliance jurídico estrito. Comunidade massiva, ecossistema de derivados especializados, integração com toda ferramenta séria.

**Mistral.** Família com Mistral Large 2, Mixtral 8x22B (MoE), Mistral Nemo, Codestral para código. Empresa francesa com posicionamento europeu, com licenças variando entre Apache 2.0 nos modelos abertos e licença comercial nos modelos top-tier. A leitura importante é que a Mistral, em 2025 e 2026, evoluiu para modelo de negócio híbrido, com alguns modelos em pesos abertos e outros em API exclusiva, e a verificação da licença específica do modelo escolhido é exercício obrigatório antes da adoção.

**Qwen (Alibaba).** Família com Qwen 2.5 e Qwen 3 em variantes de 0.5B até 235B, com Qwen-Coder especializado, com força particular em multilíngue incluindo português. Licença Apache 2.0 nos modelos abertos, com posicionamento como alternativa chinesa séria. A integração com a comunidade Hugging Face é completa, e o desempenho em português brasileiro em benchmarks recentes é competitivo, em alguns casos superando os modelos americanos no idioma.

**Microsoft Phi 4.** Filosofia de modelo pequeno (14B) treinado em dados curados, com qualidade acima do esperado para o tamanho. Licença MIT. Útil em casos em que o requisito é caber em hardware modesto, em edge, em laptop com GPU integrada, e a qualidade absoluta não é o piso crítico.

**Google Gemma 3.** Família com 2B, 9B, 27B, incluindo capacidade multimodal nativa. Licença Gemma com restrições de uso específicas. Útil para experimentação e protótipo, com integração madura com o ecossistema Google.

A síntese para o operador: em 2026, o leitor que precisa decidir adoção tem pelo menos cinco famílias open source com qualidade aceitável para uso corporativo sério, com licenças que vão de MIT estrito (DeepSeek) a Apache 2.0 (Mistral e Qwen abertos) a licenças com restrição (Llama, Gemma). A pergunta de licença é a primeira pergunta técnica, e não pode ser delegada ao engenheiro sem revisão do jurídico interno.
...
A consequência operacional para a PME brasileira em 2026 é estrutural. Modelo da qualidade do DeepSeek V3 ou do Llama 3.3 70B, em quantização INT4 com AWQ, roda em uma única H100 de 80 GB com folga para batching, com custo de aluguel de aproximadamente 2 a 4 dólares por hora em provedor de nuvem com GPU dedicada, com throughput suficiente para atender operação de PME com centenas a poucos milhares de requisições por hora. A barreira de entrada caiu, e a aritmética do TCO precisa ser refeita em 2026 com esse mapa atualizado.
...
A LGPD, em vigor desde 2020 e em maturação contínua, e a Nota Técnica da ANPD sobre IA generativa de 2026, criaram um vetor de decisão que é estruturalmente diferente do vetor de custo, e que importa especificamente para organizações brasileiras que processam dado pessoal sensível.
...
![Trade-offs estruturais entre self-hosting open source e API proprietária](file:///sessions/relaxed-cool-bell/mnt/Ebook IA/Livro-1-Os-Invariantes/02-capitulos/imagens/cap-16-img-02-tradeoffs-open-source.svg)
...
**Hardware.** Uma GPU H100 de 80 GB em provedor brasileiro de nuvem (AWS São Paulo, Magalu Cloud, equivalente) custa aproximadamente entre 4.000 e 8.000 reais por mês em compromisso de um ano, com a variação dependendo de provedor e de instância específica. Para alta disponibilidade, com pelo menos uma GPU redundante, o custo dobra. Para operação 24×7 com pelo menos duas GPUs ativas e uma stand-by, o custo triplica.

**Time especializado.** A operação de self-hosting exige pelo menos um engenheiro com competência específica em inferência, em quantização, em observabilidade de GPU. Custo mensal no Brasil em 2026, em valor de mercado, entre 25.000 e 50.000 reais para sênior, com a regra prática de que pelo menos meio FTE é dedicação realista, com risco de bus factor obrigando a manter o conhecimento em pelo menos duas pessoas.

**Energia e infraestrutura.** Em uso de provedor de nuvem, está incluso na taxa horária. Em data center próprio, soma de 30% a 50% ao custo do hardware. Para PME brasileira em 2026, provedor de nuvem é claramente o caminho dominante, com data center próprio sendo opção apenas em organização com escala e com regulação que justifique.

**Atualização contínua.** O ecossistema open source produz modelo novo a cada três a seis meses, com adoção exigindo trabalho de migração, de calibração, de validação. Custo de manutenção em janela de 12 meses, em ordem de grandeza, é equivalente ao custo de pelo menos 20% do tempo do engenheiro especializado.

**Risco operacional.** Incidente em produção, quando o modelo falha, é responsabilidade integral da equipe. Não há suporte de provedor para acionar, e a maturidade de SRE precisa estar instalada. Custo composto em incidente sério pode chegar a dezenas de horas de engenharia por evento.

A matriz aritmética para decisão, em valor de mercado brasileiro em 2026:

| Volume mensal | Recomendação primária | Lógica |
|--------------|------------------------|--------|
| < 3.000 requisições | API exclusiva | Custo de self-hosting (mínimo ~10.000 reais/mês com GPU + time parcial) excede largamente o custo de API; complexidade não se justifica |
| 3.000 a 100.000 requisições | API com avaliação contínua de migração | Zona intermediária; depende de tipo de tarefa, de requisito de soberania, de maturidade do time |
| 100.000 a 1 milhão | Híbrido ou self-hosting | Ponto de virada econômico aparece; arquitetura híbrida com classificador roteando entre rotas é o padrão maduro |
| > 1 milhão | Self-hosting prioritário | Volume saturado justifica investimento; API para tarefas residuais de fronteira |

A regra prática: a faixa intermediária é onde a maioria das PMEs brasileiras opera em 2026, e onde a arquitetura híbrida (open source para tarefas em volume saturado, API para tarefas de fronteira ou em baixo volume) entrega o ótimo, e onde a discussão "open source ou API" virou pergunta errada que precisa ser substituída pela pergunta "qual mistura, com qual classificador".

---

## Quadro 16.A — Matriz de TCO em 12 meses para PME brasileira (ordem de grandeza, 2026)

A tabela abaixo é estimativa de ordem de grandeza, com valores nominais em reais aproximados, para PME brasileira hipotética com 40 a 200 funcionários, operando IA em volume médio-alto. Os números são ilustrativos do padrão estrutural; a aritmética específica precisa ser refeita pelo leitor com os preços correntes do provedor escolhido e com o volume real da operação.

| Componente | API exclusiva (Claude Sonnet) | Self-hosting (DeepSeek V3 INT4 em H100 dedicada) | Híbrido |
|------------|------------------------------|--------------------------------------------------|---------|
| Custo de API/inferência | ~600.000 (~50.000/mês para 100k req/dia média) | ~0 (incluso na GPU) | ~180.000 (30% do volume em API) |
| Custo de GPU dedicada | 0 | ~80.000 (2 GPUs H100 com redundância) | ~80.000 (mesma infraestrutura) |
| Time especializado (meio FTE sênior) | ~0 (operação trivial) | ~250.000 | ~250.000 |
| Operação de DevOps incremental | ~30.000 (observabilidade Langfuse) | ~80.000 (observabilidade + SRE de GPU) | ~80.000 |
| Atualização de modelo e migração | 0 (provedor atualiza) | ~50.000 (esforço de migração) | ~50.000 |
| Reserva de contingência (15%) | ~95.000 | ~70.000 | ~95.000 |
| **Total estimado em 12 meses** | **~725.000** | **~530.000** | **~735.000** |

A leitura honesta desta matriz, com os números acima sendo ilustrativos: em volume alto (100k req/dia), self-hosting tem TCO menor por margem significativa, mas a margem é menor do que a leitura ingênua da API sozinha sugere, e a margem se inverte em volume menor. O híbrido tem custo total próximo da API exclusiva no exemplo, mas entrega benefícios não-monetários (soberania de dado sensível em rota self-hosted, capacidade de fine-tuning quando necessário, fronteira de qualidade em rota API quando a tarefa exige), e essa entrega não-monetária é o que justifica a arquitetura na maioria dos casos.
...
Healthtech brasileira em Florianópolis, cerca de quarenta funcionários, equipe de tecnologia de oito pessoas, operando desde 2023 uma plataforma de prontuário eletrônico com IA conversacional para apoio a clínicas pequenas (médico de família, pediatria, ginecologia), com integração com dados de paciente, com sugestão de hipótese diagnóstica como apoio (sempre com decisão final humana), com geração de minuta de prontuário, com volume mensal de cerca de 800.000 interações com modelo em meados de 2025. A operação inicial era totalmente em API da OpenAI, com GPT-4o como modelo principal, com custo mensal de inferência beirando os 90.000 reais em outubro de 2025, com a fatura crescendo a uma taxa de 8% ao mês conforme a base de clínicas crescia.

A decisão de migração começou com pressão composta de três frentes simultâneas. Primeiro, a fatura crescente projetava 180.000 reais mensais até o terceiro trimestre de 2026 mantida a curva, com a margem do produto se comprimindo de forma material. Segundo, a discussão jurídica interna sobre transferência internacional de dado pessoal de saúde, com a Nota Técnica da ANPD de 2026 elevando a barra de compliance, com o jurídico interno e o DPO contratado recomendando avaliação séria de operar o modelo em território nacional. Terceiro, a chegada do DeepSeek V3 em dezembro de 2024 e a evolução da família em 2025, com benchmarks internos demonstrando qualidade competitiva em tarefas centrais (geração de prontuário em português, sugestão diagnóstica conservadora, conversação clínica), com a diretoria autorizando piloto sério.

A migração foi conduzida em janela de quatro meses, com a equipe técnica investindo cerca de oitocentas horas de engenharia. A arquitetura final adotou DeepSeek V3 em quantização AWQ INT4, rodando em duas GPUs H100 alugadas na Magalu Cloud em data center brasileiro (com a terceira contratada como stand-by em janela de pico), com vLLM como engine de inferência, com Langfuse como observabilidade, com classificador interno simples decidindo entre o modelo self-hosted e API residual para tarefas raras de complexidade alta (consulta com hipótese diagnóstica em paciente com sintomatologia complexa, em cerca de 3% do volume total).

Os resultados, computados em janela de 90 dias após a migração, com auditoria interna validada por terceiro independente contratado para a tarefa, foram os seguintes. Custo total de inferência caiu de 90.000 reais mensais (com projeção de 180.000) para 24.000 reais mensais, com economia composta de 73% no acumulado de noventa dias e com a curva de crescimento radicalmente menor (a expansão de volume não escala custo de API, apenas a utilização das GPUs já contratadas). Latência média subiu cerca de 200 ms (de aproximadamente 800 ms para 1.000 ms) em função do roundtrip para o data center brasileiro e da operação em quantização, com o impacto na experiência do usuário sendo avaliado como "imperceptível" em pesquisa com 200 médicos usuários. Qualidade medida em suite de avaliação interna, com 450 casos curados, manteve nota composta acima de 92% (versus 94% da operação original com GPT-4o), com a queda de 2 pontos sendo concentrada em consultas de complexidade alta que foram roteadas para a API residual.
...
Faça três perguntas ao time esta semana. (1) Qual é o nosso TCO honesto de IA em 12 meses, com hardware, time, energia, atualização e contingência somados, comparado com a fatura de API que pagamos hoje? (2) Quanto do nosso volume é dado pessoal sensível que faria sentido manter em território nacional sob a Nota Técnica da ANPD de 2026? (3) Qual seria a arquitetura híbrida mínima viável que captura 80% do benefício com 20% do esforço de migração total?
...
| Conceito | Síntese |
|----------|---------|
| **Virada de 2024-2026** | DeepSeek V3 e R1 reorganizaram a fronteira; open source virou fronteira de qualidade, não apenas alternativa barata |
| **Família competitiva 2026** | DeepSeek (MIT), Llama 3.3-4 (restrita), Mistral (mista), Qwen (Apache), Phi (MIT), Gemma (restrita) |
...
- [ ] Reconhecer a virada estrutural de 2024-2026 com DeepSeek V3 e R1
- [ ] Distinguir open weights de open source no sentido estrito da OSI
- [ ] Listar pelo menos cinco famílias open source competitivas em 2026 com licença respectiva
...
1. Por que a virada de 2024-2026 mudou estruturalmente a discussão de open source × API, e qual é o evento técnico específico do DeepSeek que materializou a mudança?
...
5. Como a Nota Técnica da ANPD de 2026 sobre IA generativa desloca a fronteira em favor de operação em território nacional, e em que tipo de dado essa pressão é mais aguda?
...
**Exercício 3 — Piloto controlado de modelo open source.** Em janela de seis semanas, conduza piloto de DeepSeek V3 ou de Llama 3.3 70B em ambiente isolado, com suite de avaliação interna de pelo menos 100 casos representativos da operação real, com comparação de qualidade contra o modelo proprietary em uso. O entregável é o relatório com decisão de avanço ou abandono baseada em dados.
...
- [DeepSeek](https://www.deepseek.com/) e papers técnicos do DeepSeek V3 e R1
...
|---|----------|----------------|
| 1 | **Clareza** — Explicar em 90 segundos a um CFO por que a virada de 2024-2026 com DeepSeek reorganizou o mapa de decisão, e por que a discussão "open source ou API" virou pergunta errada | ☐ |
| 2 | **Profundidade** — Defender, em mesa técnica com CTO experiente, a arquitetura híbrida com classificador como padrão maduro de 2026, com argumento que combina TCO honesto, soberania LGPD e fronteira de qualidade | ☐ |
...
| 5 | **Curiosidade** — Está com vontade de conduzir piloto controlado de DeepSeek V3 ou Llama 3.3 na operação real nas próximas seis semanas, com suite de avaliação interna | ☐ |

---

---

> *"Open source em 2026 virou fronteira de qualidade competitiva, não alternativa barata de qualidade inferior. Quem opera com o mapa de 2022 está deixando dinheiro, soberania regulatória e qualidade de produto na mesa. A decisão de 2026 não é binária, é arquitetura híbrida com classificador, com cadência semestral de revisão; e quem chega no fim do ano com TCO honesto e com soberania efetiva é o operador, não o entusiasta nem o conservador."*
...
![Mapa de categorias de repositórios relevantes no ecossistema de IA](file:///sessions/relaxed-cool-bell/mnt/Ebook IA/Livro-1-Os-Invariantes/02-capitulos/imagens/cap-35-img-01-repos-categoria.svg)
...
**CI/CD ativo.** A presença de pipeline de integração contínua, com GitHub Actions visível na aba Actions, com badges de status no README, com histórico de builds verde nos últimos commits, é o segundo piso. Projeto com CI vermelho na branch principal é projeto que ou negligenciou o sinal por descuido, ou aceita produção quebrada como normal; ambas as interpretações são red flag para uso em organização que vai depender do projeto.
...
A lista abaixo é exercício de aplicação do método, não inventário durável. Cada repositório recebe uma linha sobre o estado observado em meados de 2026, com a expectativa explícita de que o estado deteriore ou evolua antes do próximo ciclo de leitura. O leitor é convidado a auditar cada um dos oito com o protocolo de trinta minutos, comparar a leitura própria com a linha abaixo, e calibrar o método para o próximo conjunto que aparecer em conferência.

**LangChain.** Fase de maturidade com sinais de manutenção; cadência de release alta, ecossistema massivo, comunidade ativa, governança institucional formalizada via LangChain Inc; questão crítica para adoção é encaixe, com a complexidade do framework justificando-se em equipes que operam múltiplos modelos e múltiplas tools simultaneamente, com over-engineering documentado em equipes que operam um único caso de uso.

**LlamaIndex.** Fase de maturidade, com foco específico em RAG, com comunidade técnica séria, com cadência de release saudável; encaixe forte em organização que opera RAG como caso principal, com competição direta com Haystack e com implementação custom em equipes maduras; documentação operacional de qualidade alta.

**vLLM.** Fase de maturidade com adoção em produção corporativa consolidada; infraestrutura de inferência otimizada, com governança em organização universitária séria, com integração madura com Hugging Face e com ecossistema de inferência; encaixe forte em organização que opera self-hosting de modelo de fronteira.

**Ollama.** Fase de adoção real para uso local e prototipação; experiência de desenvolvedor de qualidade alta, com governança em empresa comercial dedicada, com cadência de release alta; encaixe forte em uso pessoal, em prototipação, em demo, com encaixe duvidoso em produção corporativa de alto volume onde vLLM e TGI dominam.

**OpenInterpreter.** Fase de adoção real com sinais de transição; projeto interessante na fronteira de agente que executa código, com cadência variável, com governança em pessoa física com empresa em formação; encaixe limitado em produção corporativa em 2026, com adoção em sandbox e em uso individual sendo o ponto natural.

**LiteLLM.** Fase de maturidade com adoção em produção; gateway unificado para múltiplos provedores de modelo, com cadência alta de release, com comunidade ativa, com governança em empresa comercial; encaixe forte em organização que opera multi-provedor, com a questão crítica sendo a observabilidade nativa versus integração com Langfuse ou equivalente.

**MLflow.** Fase de manutenção em ecossistema clássico de ML, com extensão recente para LLMOps; cadência de release saudável, governança institucional via Databricks, comunidade técnica madura; encaixe forte em organização que já opera MLflow para modelos clássicos e quer estender para LLM, com encaixe duvidoso em organização nativa de LLM que não tem o histórico de ML clássico.

**Weights & Biases.** Fase de maturidade com componente proprietário dominante; ferramenta de experimentação e observabilidade líder, com cadência de release alta no SDK open source, com modelo de negócio em camada hospedada; encaixe forte em organização que vai operar com a camada hospedada, com encaixe duvidoso em organização que precisa de operação totalmente self-hosted por restrição regulatória.

A regra explícita: esta lista vai envelhecer. A leitura honesta do leitor em meados de 2027 vai encontrar mudança em pelo menos três dos oito itens, com transição de fase, com mudança de governança, com aparição de competidor que reorganiza o quadrante. O exercício de aplicação é, exatamente, ler a lista contra o estado observado pelo próprio leitor na data da leitura, com o método continuando válido independentemente da rotação dos itens.
...
**◆ Repositórios usados como exercício de aplicação (estado observado em meados de 2026)**

- LangChain, LlamaIndex, vLLM, Ollama, OpenInterpreter, LiteLLM, MLflow, Weights & Biases
...
A versão corrente de cada projeto, especialmente a fase do ciclo de vida, precisa ser auditada pelo leitor na data da leitura conforme o protocolo de trinta minutos. A lista vai envelhecer, o método não.
...
Tier é o multiplicador de modelo. Usar o modelo premium para classificação binária paga 30 a 50 vezes o preço do modelo pequeno para entregar a mesma qualidade. Tier mal escolhido é, em volume, o erro mais caro do início ao fim.
...
> | **Tier** | Modelo premium onde o pequeno bastaria | 30-50× por chamada mal roteada | Roteamento (T1) |
>
...
![Economia tokens](file:///sessions/relaxed-cool-bell/mnt/Ebook IA/Livro-1-Os-Invariantes/02-capitulos/imagens/cap-36-img-01-economia-tokens.svg)
...
- Documentação oficial de prompt caching e tiers de modelo dos principais fornecedores (Anthropic, OpenAI, Google) — fonte primária para preços e mecânica de caching, que mudam com frequência; conferir versões pontuais no Apêndice J.
...
**Indireta via dados de tool.** Em arquitetura agêntica, o agente invoca uma tool que retorna dado externo, e esse dado pode conter instrução adversarial, com o caso público de EchoLeak (CVE-2025-32711) ilustrando a classe em ambiente corporativo. A defesa exige tratamento de output de tool como dado não confiável, com sanitização e com escopo de ação subsequente reduzido ao mínimo necessário.
...
**Nota Técnica da ANPD sobre IA generativa.** A ANPD publicou orientação específica sobre IA generativa e tratamento de dado pessoal em vigor a partir de 2026, com diretrizes sobre base legal de tratamento, sobre transparência ao titular, sobre avaliação de impacto à proteção de dados (RIPD) específica para sistemas com IA generativa. A organização que opera IA em escala precisa ler o documento oficial, atualizado, e a verificação da versão corrente é feita conforme método do Apêndice J — Trilha do Número. A síntese durável: avaliação de impacto formal antes da entrada em produção, comunicação ao titular sobre uso de IA no tratamento, registro de base legal documentado.
...
**PL 2338/2023 (Marco Legal da IA brasileiro).** O projeto, em tramitação no Senado Federal, instala regime de classificação por risco análogo ao AI Act, com obrigações proporcionais. A versão corrente do texto deve ser confirmada em fonte oficial datada na hora da decisão, conforme padrão da Camada Dupla. A síntese durável: classificação por risco, obrigações graduadas, trilha de auditoria, direito à explicação, regime sancionatório integrado à LGPD.
...
- [ ] Reconhecer a versão corrente da Nota Técnica da ANPD sobre IA generativa
