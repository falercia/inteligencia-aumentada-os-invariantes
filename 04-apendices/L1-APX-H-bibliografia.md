...
- Kotter, J. *Leading Change* (1996). (Modelo de oito etapas de transformação organizacional; base dos marcos de 90/180/365 dias do APX-C.)
- Davenport, T. *The AI Advantage* (2018)
- Schmidhuber, J. *Annotated History of Modern AI* (schmidhuber.ch, atualizado periodicamente)
...
> Para curadoria comentada de leituras, cursos e fontes de acompanhamento, ver Apêndice E — Como montar sua dieta de informação.
