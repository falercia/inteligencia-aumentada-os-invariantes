...
- **Os Nove Princípios ★** — Introdução; Apêndice B (Mapa Mental)
...
- **Nove Frameworks ★** — APX-A (Cat. I, entradas individuais); APX-B (tabela Princípio × Framework)
- **Nove Princípios ★** — Introdução; APX-B (Mapa Mental)
...
- **Reasoning models ◆** — capítulo C14B (Reasoning models); Princípio 1
...
- **Spec-driven development** — capítulo C14C; Princípios 4 e 8
