...
## *Termos, métodos, invariantes e casos — onde encontrar na obra*
...
- **Autonomia Proporcional ★** — Invariante 6; capítulo sobre Agentes; capítulo sobre LLMOps; Escala de Propriedade do Agente
...
## C
- **Camada Dupla ★** — Invariante 3; capítulo O que é IA; Rota Dupla de Adoção
...
- **Custo Composto ★** — Invariante 5; capítulo sobre Economia de tokens; Custo Composto em Três Tempos

## D
- **Datasets de prática** — Apêndice D (critério de seleção de ferramentas e fontes de dados)
- **Método de Decisão para Adotar IA** — método derivado do Invariante 9
- **DPO (Direct Preference Optimization)** — capítulo sobre Alinhamento

## E
- **Embeddings ◆** — capítulo sobre Embeddings
- **Encaixe ★** — Invariante 4; capítulo sobre Comparação de modelos; Diagnóstico de Encaixe entre Tarefa e Modelo
- **Evals** — capítulo sobre Evals; Pirâmide da Avaliação
- **Pirâmide da Avaliação** — método derivado do Invariante 7
- **Extremidades ★** — Invariante 2; capítulo sobre Janela de contexto; Engenharia de Prompt Estendida
...
## G
- **Gabaritos** — capítulo sobre Evals; Pirâmide da Avaliação
- **Glossário** — Apêndice A
- **Golden set ◆** — capítulo sobre Evals; Pirâmide da Avaliação
- **Governança Indelegável** — método derivado do Invariante 8
...
- **Os Nove Invariantes ★** — Introdução; Apêndice B (Mapa Mental)
...
- **Lost in the Middle ◆** — capítulo sobre Janela de contexto; Invariante 2
...
- **Matriz de Cobertura de Integrações** — método derivado dos Invariantes 4 e 6
- **Memória ◆** — capítulo sobre Memória
- **MTTR** — capítulo sobre LLMOps

## N
- **NIST AI RMF** — capítulos sobre Governança e Segurança e riscos; APX-A (Regulação, Cat. IX); APX-H (Seção III)
- **Nove Frameworks ★** — APX-A (Cat. I, entradas individuais); APX-B (tabela Invariante × Framework)
- **Nove Invariantes ★** — Introdução; APX-B (Mapa Mental)

## O
- **Open source (modelos)** — capítulo sobre Open source; trade-offs canônicos
- **OpenTelemetry GenAI** — capítulo sobre LLMOps
- **Operador ★** — Invariante 9; capítulo sobre Roadmap pessoal; Método de Decisão para Adotar IA
- **Over-refusal** — capítulo sobre Alinhamento

## P
- **Plausibilidade ★** — Invariante 1; capítulo sobre Como modelos funcionam; Manifesto de Bolso (APX-M)
...
- **Engenharia de Prompt Estendida** — método derivado dos Invariantes 2 e 3
...
- **Reasoning models ◆** — capítulo C14B (Reasoning models); Invariante 1
- **Refusal training** — capítulo sobre Alinhamento
- **Responsabilidade Indelegável ★** — Invariante 8; capítulo sobre Governança; Governança Indelegável
...
- **Rota Dupla de Adoção** — método derivado do Invariante 3
...
- **Spec-driven development** — capítulo C14C; Invariantes 4 e 8
- **Sycophancy** — capítulos sobre Alinhamento e Evals

## T
- **Termômetro ★** — Invariante 7; capítulo sobre Evals; Pirâmide da Avaliação
...
- **Vianna, Castro e Almeida (caso)** — Engenharia de Prompt Estendida
